...
class PDFKnowledgeExtractor:
    ...
    def find_similar_question(self, user_question: str, threshold: float = 0.3) -> Optional[Dict[str, Any]]:
        ...
        # Fix: Proper check for embeddings existence
        ...
        try:
            ...
            print(f"Best match: {self.knowledge_base['qa_pairs'][best_match_idx]['question']}")
            
            if best_similarity >= threshold:
                result = self.knowledge_base["qa_pairs"][best_match_idx].copy()
